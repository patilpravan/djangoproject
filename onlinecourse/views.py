...
# <HINT> Create a submit view to create an exam submission record for a 
# course enrollment,
# you may implement it based on following logic:
         # Get user and course object, then get the associated enrollment
         # object created when the user enrolled the course
